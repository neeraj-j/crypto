...
def main():
    ...
    model = eval("models." + cfg.MODEL.NAME + ".get_wav2vec")(cfg, is_train=True)
    ...
    dump_input = torch.rand((1, cfg.DATASET.MAX_SAMPLE_SIZE))
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        perf_indicator = validate(
            cfg, valid_loader, valid_dataset, model, criterion, final_output_dir
        )
